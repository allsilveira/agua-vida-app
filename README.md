...
Aplicativo desenvolvido em **React Native** com **Expo** para conectar clientes e fornecedores de bombonas de água de forma rápida e eficiente.

## 📌 Sobre o Projeto

O **Água Vida App** tem como objetivo facilitar a compra de bombonas de água, conectando consumidores a fornecedores próximos, garantindo praticidade e segurança na entrega.
...
O **Água Vida App** conta com diversas funcionalidades que tornam a experiência do usuário mais prática e eficiente:
